...
router.get('/children',userController.childPage)
router.get('/allproducts',userController.allPage)
router.get('/allproducts/:id',userController.allPage)
...
router.put('/price-high',userController.priceHigh)
